...
class Mailbox(Drawable):
    ...
    def __init__(self,flagUp=False,doorOpen=False,color='yellow',message=''): #mesajı  alacak
        ...
        self._message = Text(message,12,Point(0,-90)) #kutumuza kisa mesajimizi ekledik
    ...
    def _draw(self):
        ...
        self._door._draw( )
        self._flag._draw( )
        self._message._draw() # mesaji yaziyoruz
        self._completeDraw( )
